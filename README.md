...
#### 1- Criamos primeiramente uma VPC, recomendado 2 zonas de disponibilidade.
#### 2- Agora criamos um ACL da Web para filtrar as solicitações do CloudFront
#### 3- Agora vamos criar uma função Lambda para se conectar ao S3 
